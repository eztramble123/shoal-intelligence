...
export function LoginForm({
  ...
  useEffect(() => {
    ...
    // Removed email verification messages since we don't use email verification anymore
    if (error) {
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            <p style={{
              ...
              Sign in to access Shoal Intelligence platform
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ width: '100%' }}>
            ...
            >
              {loading ? 'Accessing...' : 'Access Platform'}
            </Button>
      ...
      <div 
        ...
        <div style={{
          ...
          <p style={{
            ...
            Early access to comprehensive digital asset intelligence and market analytics platform.
          </p>
        </div>
      </div>
    </div>
